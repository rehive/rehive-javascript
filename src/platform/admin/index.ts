import { Api as GeneratedAdminApi } from './rehive-platform-admin-api.js';
 ...
 */
export class RehivePlatformAdminApi<SecurityDataType = unknown> extends GeneratedAdminApi<SecurityDataType> {
...
export { Api as RawPlatformAdminApi } from './rehive-platform-admin-api.js';

// Re-export types
export * from './rehive-platform-admin-api.js';