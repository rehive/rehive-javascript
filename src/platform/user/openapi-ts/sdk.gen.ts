 ...
 */
export const authTokensPartialUpdate = <ThrowOnError extends boolean = false>(options: Options<AuthTokensPartialUpdateData, ThrowOnError>) => (options.client ?? client).patch<AuthTokensPartialUpdateResponses, unknown, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/3/auth/tokens/{token_key}/',
    ...options,
    headers: {
 ...
 * Update auth token
 */
export const authTokensUpdate = <ThrowOnError extends boolean = false>(options: Options<AuthTokensUpdateData, ThrowOnError>) => (options.client ?? client).put<AuthTokensUpdateResponses, unknown, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/3/auth/tokens/{token_key}/',
    ...options,
    headers: {
