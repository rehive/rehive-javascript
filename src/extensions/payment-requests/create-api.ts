...
export type PaymentRequestsApi = BoundSdk<typeof sdk>;

export function createPaymentRequestsApi(config: ApiFactoryConfig): PaymentRequestsApi {
  const client = createClient(
    buildClientConfig(config, 'https://payment-requests.services.rehive.com/api/'),
  );
