...
export type StellarApi = BoundSdk<typeof sdk>;

export function createStellarApi(config: ApiFactoryConfig): StellarApi {
  const client = createClient(
    buildClientConfig(config, 'https://stellar.services.rehive.com/api/'),
  );
