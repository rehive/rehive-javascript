...
// the full API client from the rain service swagger spec.
...
/**
 * @title Rain Service API
 * @baseUrl https://rain.services.rehive.com/api/
 * @externalDocs https://docs.rehive.com
 * @contact Rehive Support <support@rehive.com> (https://rehive.com/support/)
 *
 *
 * The **Rain Service API** is used for managing rain in Rehive.
 *
 */
export class Api<
