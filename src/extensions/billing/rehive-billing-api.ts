...
// the full API client from the billing service swagger spec.
 ...
 * @baseUrl https://billing.services.rehive.com/api/
 * @externalDocs https://docs.rehive.com
 * @contact Rehive Support <support@rehive.com> (https://rehive.com/support/)
 *
 *
 * The **Billing Service API** is used for managing billing in Rehive.
 *
 */
export class Api<
