...
!function(){function t(t){sessionStorage.setItem("token",t)}function n(t){return sessionStorage.getItem("token")||""}function e(){delete axios.defaults.headers.common.Authorization,sessionStorage.removeItem("token")}function o(t,e,o){var a=n();a?axios.defaults.headers.common.Authorization="Token "+a:delete axios.defaults.headers.common.Authorization,axios.post(nt+t,e,Nt).then(function(t){(200==t.status||201==t.status)&&(t.data.data?o(null,t.data.data):o(null,t.data))})["catch"](function(t){o(t.response.data,null)})}function a(t,e,o){var a=n();a?axios.defaults.headers.common.Authorization="Token "+a:delete axios.defaults.headers.common.Authorization,axios.get(nt+t,e,Nt).then(function(t){200==t.status&&(t.data.data?o(null,t.data.data):o(null,t.data))})["catch"](function(t){console.log(t.response),o(t.response.data,null)})}function s(t,e,o){var a=n();a?axios.defaults.headers.common.Authorization="Token "+a:delete axios.defaults.headers.common.Authorization,axios.patch(nt+t,e,Nt).then(function(t){(200==t.status||201==t.status)&&(t.data.data?o(null,t.data.data):o(null,t.data))})["catch"](function(t){o(t.response.data,null)})}function u(t,e,o){var a=n();a?axios.defaults.headers.common.Authorization="Token "+a:delete axios.defaults.headers.common.Authorization,axios["delete"](nt+t,e,Nt).then(function(t){console.log(t),200==t.status&&(t.data.data?o(null,t.data.data):o(null,t.data))})["catch"](function(t){o(t.response.data,null)})}function i(n,e){axios.post(nt+et,n,Nt).then(function(n){201==n.status&&(t(n.data.data.token),e(null,n.data.data.user))})["catch"](function(t){e(t.response.data,null)})}function c(n,e){axios.post(nt+ot,n,Nt).then(function(n){201==n.status&&(t(n.data.data.token),e(null,n.data.data.user))})["catch"](function(t){e(t.response.data,null)})}function r(n,e){axios.post(nt+at,n,Nt).then(function(n){200==n.status&&(t(n.data.data.token),e(null,n.data.data.user))})["catch"](function(t){e(t.response.data,null)})}function d(t){var o=n();return o?(axios.defaults.headers.common.Authorization="Token "+o,void axios.post(nt+st,Nt).then(function(n){200==n.status&&(e(),t(null,n.data))})["catch"](function(n){t(n.response.data,null)})):t(null,{message:"User Already Logged Out"})}function l(t){var o=n();return o?(axios.defaults.headers.common.Authorization="Token "+o,void axios.post(nt+ut,Nt).then(function(n){200==n.status&&(e(),t(null,n.data))})["catch"](function(n){t(n.response.data,null)})):t(null,{message:"User Already Logged Out"})}function f(t,n){o(it,t,n)}function h(t,n){o(ct,t,n)}function m(t,n){o(rt,t,n)}function p(t,n){o(dt,t,n)}function g(t,n){o(lt,t,n)}function A(t,n){o(ft,t,n)}function k(t){a(ht,{},t)}function U(t,n){o(ht,t,n)}function x(t,n){u(ht+t,{},n)}function y(t){a(mt,{},t)}function v(t,n){s(mt,t,n)}function b(t){a(pt,{},t)}function T(t,n){s(pt,t,n)}function w(t){a(gt,{},t)}function z(t,n){o(gt,t,n)}function C(t,n,e){s(gt+t,n,e)}function B(t,n){u(gt+t,{},n)}function L(t){a(At,{},t)}function M(t,n){o(At,t,n)}function N(t,n,e){s(At+t,n,e)}function P(t,n){o(kt,t,n)}function E(t){a(Ut,{},t)}function D(t,n){o(Ut,t,n)}function I(t,n,e){s(Ut+t,n,e)}function S(t){a(xt,{},t)}function O(t,n){o(xt,t,n)}function V(t,n,e){s(xt+t,n,e)}function _(t){a(yt,{},t)}function j(t,n,e){s(yt+t,n,e)}function R(t,n){t=t?"?"+t:"",a(vt+t,{},n)}function W(t,n){t=t?"?"+t:"",a(vt+bt+t,{},n)}function q(t,n){a(vt+t+"/",{},n)}function F(t,n){o(Tt,t,n)}function G(t,n){o(wt,t,n)}function H(t,n){t=t?"?"+t:"",a(zt+t,{},n)}function J(t,n,e){t+="/",n=n?"?"+n:"",a(zt+t+n,{},e)}function K(t,n,e){n=n?"?"+n:"",a(zt+t+Ct+n,{},e)}function Q(t,n,e){a(zt+t+Ct+n+"/",{},e)}function X(t,n,e,o){s(zt+t+Ct+n+"/",e,o)}function Y(t){a(Bt,{},t)}function Z(t,n){t?t+="/":t="",a(Lt+t,{},n)}function $(t){a(Mt,{},t)}var tt={},nt="https://rehive.com/api/3/",et="auth/register/",ot="auth/company/register/",at="auth/login/",st="auth/logout/",ut="auth/logout/all/",it="auth/password/change/",ct="auth/password/reset/",rt="auth/password/reset/confirm/",dt="auth/email/verify/resend/",lt="auth/mobile/verify/resend/",ft="auth/mobile/verify/",ht="auth/tokens/",mt="user/",pt="user/address/",gt="user/bank_accounts/",At="user/bitcoin_accounts/",kt="user/document/",Ut="user/emails/",xt="user/mobiles/",yt="user/notifications/",vt="transactions/",bt="totals/",Tt="transactions/withdraw/",wt="transactions/deposit/",zt="accounts/",Ct="/currencies/",Bt="company/",Lt="company/currencies/",Mt="company/bank/",Nt={header:"Content-Type: application/json"};return tt.auth={register:i,registerCompany:c,login:r,logout:d,logoutAll:l,changePassword:f,resetPassword:h,resetConfirmPassword:m,resendEmailVerification:p,resendMobileVerification:g,verifyMobile:A},tt.token={getTokensList:k,createToken:U,deleteToken:x},tt.user={getUserProfile:y,updateUserProfile:v,getUserAddress:b,updateUserAddress:T,getUserBankAccounts:w,createUserBankAccount:z,updateUserBankAccount:C,deleteUserBankAccount:B,getUserBitcoinAccounts:L,createUserBitcoinAccount:M,updateUserBitcoinAccount:N,createDocument:P,getUserEmailAddresses:E,createUserEmailAddresses:D,updateUserEmailAddresses:I,getUserMobileNumbers:S,createUserMobileNumbers:O,updateUserMobileNumbers:V,getUserNotifications:_,updateUserNotifications:j},tt.transactions={getListTransactions:R,getTotalTransactionsList:W,getTransaction:q,createWithdrawal:F,createDeposit:G},tt.accounts={getAccountsList:H,getAccount:J,getAccountCurrenciesList:K,getAccountCurrency:Q,updateAccountCurrency:X},tt.company={getCompanyDetails:Y,getCompanyCurrencies:Z,getCompanyBanks:$},window.Rehive=tt}();
